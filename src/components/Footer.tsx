...
export function Footer() {
  return (
    <footer className="relative mt-auto overflow-hidden border-t border-primary/10 bg-primary text-cream">
      ...
      <div className="relative mx-auto grid max-w-6xl gap-10 px-4 py-14 md:grid-cols-3 md:px-6">
        <div>
          <LogoMark variant="inverse" size="lg" />
          <p className="mt-5 font-display text-2xl font-semibold">Instituto de Previdência de Contagem</p>
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto flex max-w-6xl flex-col gap-2 px-4 py-4 text-sm text-cream/75 md:flex-row md:items-center md:justify-between md:px-6">
